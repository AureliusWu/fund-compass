...
.estimate-row { min-height: 76px; display: grid; grid-template-columns: minmax(0, 1fr) clamp(140px, 34vw, 240px); align-items: center; gap: 14px; padding: 13px 14px; border-bottom: 1px solid var(--border); cursor: pointer; }.van-swipe-cell:last-child .estimate-row { border-bottom: 0; }
